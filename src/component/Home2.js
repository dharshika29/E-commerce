...
import image1 from "../Image2/s-bestseller2.png";
...
import seller6 from "../Image2/s-bestseller6.png";
  ...
  return (
    <>
      ...
      <div className={styles.hero3}>
        <h2 className={styles.title}>Shop Collection</h2>

        <div className={styles.grid}>

          <div
            className={styles.largeCard}
            style={{ backgroundImage: `url(${headbandImg})` }}
          >
          ...
          <div className={styles.rightCol}>
            ...
            <div
              ...
              style={{ backgroundImage: `url(${earbudsImg})` }}
            >
              <div className={styles.content}>
                <h3>Earbuds</h3>
                <a className={styles.link} href="/">
